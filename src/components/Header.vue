	...
	<header class="header float-start py-2 w-100">
	  <div class="container-fluid d-flex align-items-center justify-content-between">
		 ...
		 <nav class="font_ d-none d-md-flex justify-content-end">
			<ul class="nav-list d-flex list-unstyled mb-0 align-items-center text-center">
	  ...
	  >
		 <ul class="nav-list list-unstyled text-center m-0">
			...
			<li class="nav-item">
			  <router-link class="nav-link text-warning" :to="{ name: 'ristoranti' }">Ristoranti</router-link>
			</li>
			<li class="nav-item">
			  <router-link class="nav-link text-warning" :to="{ name: 'contacts' }">Contatti</router-link>
			</li>
			<li class="nav-item">
			  <router-link class="nav-link text-warning" :to="{ name: 'laNostraStoria' }">Chi Siamo</router-link>
			</li>
		 </ul>
	  </nav>
	  <!-- / -->
